...
> **Source:** https://docs.ray.io/en/latest/serve/advanced-guides/multi-app-container.html
> **Ray version at capture:** 2.57.0 · **Captured:** 2026-08-13
> **Relevance to tool-swap:** the single most decisive page. It is the evidence for **D2** (one image per tool) being satisfiable on Ray, and the source of the Ray/Python lockstep, Podman prerequisite, and experimental-API objections in [`15_RAY_SERVE_EVALUATION.md`](../../../15_RAY_SERVE_EVALUATION.md) §2.
...
> **Note.** Previously you could access the feature through the `container` field of the runtime environment. That API is now deprecated in favor of `image_uri`.
...
>>> resp.json()
{
    ...
    "duration": 21.775,
    "transcript_text": " Well, think about the time of our ancestors. ...",
    "whisper_alignments": [
        [0.0, 0.36, " Well,", 0.3125],
        ...
    ]
}
...
> **tool-swap note.** This list does **not** mention `CUDA_VISIBLE_DEVICES`, which is how Ray normally communicates GPU assignment to an actor process. This is open question 2 in [`15_RAY_SERVE_EVALUATION.md`](../../../15_RAY_SERVE_EVALUATION.md) §9 and bears on **D7**.
