# tool_tf — TensorFlow fixture for Spike E
# Weights and payload are baked in at build time (§0a of spike-E-implementation.md)
# Same paths as tool_torch, different bytes — lets startup_report prove which image answered.
...
# === Identity ===
ENV SPIKE_IMAGE_MARKER=tool_tf
